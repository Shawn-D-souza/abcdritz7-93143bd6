---
summary: Automate bulk WhatsApp messages in n8n using the WhatsApp Business
  Cloud API. Send templates, track delivery status, and integrate Google Sheets.
...
description: Automate bulk WhatsApp messages in n8n using the WhatsApp Business
  Cloud API. Send templates, track delivery status, and integrate Google Sheets.
---
