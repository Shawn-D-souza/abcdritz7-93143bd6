---
summary: Step-by-step guide to build a WhatsApp AI agent with n8n for text,
  audio, and image replies using OpenAI, Whisper, Vision, and WhatsApp Business
  API.
...
description: Step-by-step guide to build a WhatsApp AI agent with n8n for text,
  audio, and image replies using OpenAI, Whisper, Vision, and WhatsApp Business
  API.
---
