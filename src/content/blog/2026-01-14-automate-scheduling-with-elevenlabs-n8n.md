---
summary: Automate appointment scheduling with voice! A complete guide to
  connecting ElevenLabs Voice Agent to n8n for Google Calendar booking
  automation.
...
thumbnail_alt: AI voice agent - eleven labs
description: Automate appointment scheduling with voice! A complete guide to
  connecting ElevenLabs Voice Agent to n8n for Google Calendar booking
  automation.
---
> **Key Pointers:**
...
2. **Input the Prompt:** Use the following command to define the agent's capabilities:
   ...
   > *"Build an ai agent that can be connected via webhook and chat which checks for user's availability via Google Calendar and books an appointment based on user's preference. It should also collect user's name and email address to send the invitation."*
...
* **First Message**: Set a welcoming greeting: *"Hello, I'm here to help you schedule a meeting. What time works best for you?"*
...
5. *Example Output*: "I have checked the calendar. Thursday at 12:30 PM is available. Shall I book it?"
...
4. **Confirmation**: The agent confirms: *"Your meeting is confirmed for 12:30 PM. A Google Meet link has been sent to your email."*
