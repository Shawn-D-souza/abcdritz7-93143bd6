    ...
    <section className="relative mx-auto flex lg:min-h-screen max-w-7xl flex-col items-center justify-start px-4 sm:px-6 pt-24 sm:pt-32 pb-12 md:justify-center md:pt-28 lg:flex-row lg:justify-between lg:px-12 lg:pt-20 lg:pb-6">
      <div className="relative z-10 flex w-full max-w-2xl flex-col items-start gap-6 lg:w-1/2">
        ...
        <motion.div 
          ...
          className="mt-4 flex w-full flex-row gap-3 max-[380px]:gap-2 sm:w-auto sm:gap-4"
        >
          <a href="https://wa.me/message/RVQXUI35RJO4J1" target="_blank" rel="noopener noreferrer" className="group relative w-full flex-1 overflow-hidden rounded-full bg-primary px-4 py-3.5 text-center text-sm font-semibold text-white shadow-lg transition-transform hover:scale-105 max-[380px]:px-2 max-[380px]:text-xs sm:w-auto sm:flex-none sm:px-8 sm:py-4 sm:text-base animate-pulse-glow hover:animate-none shine-effect">
            <span className="relative z-10 w-full whitespace-nowrap max-[380px]:text-[11px]">Join the community</span>
          ...
          <a
            ...
            className="group relative w-full flex-1 overflow-hidden rounded-full border border-primary/20 bg-primary/5 px-4 py-3.5 text-center text-sm font-semibold text-foreground backdrop-blur-md transition-all hover:bg-primary/10 dark:border-primary/30 dark:bg-white/5 dark:hover:bg-white/10 max-[380px]:px-2 max-[380px]:text-xs sm:w-auto sm:flex-none sm:px-12 sm:py-4 sm:text-base flex items-center justify-center"
          >
            <span className="relative z-10 whitespace-nowrap max-[380px]:text-[11px]">Explore Programs</span>
            <ArrowRight className="absolute right-3 size-4 text-primary transition-transform group-hover:translate-x-1 max-[380px]:right-2 sm:right-6 sm:size-5" />
