...
const socials = [
  ...
  { icon: Instagram, href: "https://www.instagram.com/ritz7.ai", label: "Instagram", color: "text-[#E4405F] border-[#E4405F]/20 shadow-[0_0_8px_rgba(228,64,95,0.1)] hover:border-[#E4405F]/50 hover:shadow-[0_0_12px_rgba(228,64,95,0.3)]" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/ritz7ai", label: "LinkedIn", color: "text-[#0A66C2] border-[#0A66C2]/20 shadow-[0_0_8px_rgba(10,102,194,0.1)] hover:border-[#0A66C2]/50 hover:shadow-[0_0_12px_rgba(10,102,194,0.3)]" },
  { icon: () => <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>, href: "https://x.com/Ritz7ai", label: "X", color: "text-foreground border-border/50 shadow-[0_0_8px_rgba(0,0,0,0.1)] hover:border-foreground/50 hover:shadow-[0_0_12px_rgba(0,0,0,0.3)]" },
];
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              <a href="mailto:support@ritz7.ai" className="flex items-center gap-2 text-sm text-muted-foreground transition-colors hover:text-primary">
